...
function RouteComponent() {
  ...
  return (
    <span className='vertical h-[100dvh]'>
      <nav className="flex items-center justify-between p-4 fixed top-0 left-0 right-0 z-10 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 h-18">
