...
const buttonVariants = cva(
    "rounded-md relative cursor-pointer overflow-hidden horizontal center gap-2 transition-colors focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&>svg]:stroke-white dark:[&>svg]:stroke-zinc-900",
    {
        variants: {
            variant: {
                default: "",
                outline: "!bg-transparent border border-zinc-200 dark:border-zinc-700 hover:!bg-zinc-100/50 dark:hover:!bg-zinc-800/50",
            ...
            color: {
                ...
                secondary: "bg-zinc-100 text-zinc-900 hover:bg-zinc-200/70 dark:bg-zinc-800 dark:text-zinc-50 dark:hover:bg-zinc-800/70",
